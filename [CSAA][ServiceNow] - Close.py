...
def configure_ticket_update(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    input_parameter_2 = "assigned_to:SplunkPhantom Prod User"
...
def update_ticket_with_CI(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="update ticket", parameters=parameters, assets=['snow_prod'], callback=Check_Update_with_CI_Status, name="update_ticket_with_CI")
...
def update_ticket_without_CI(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    phantom.act(action="update ticket", parameters=parameters, assets=['snow_prod'], callback=Check_Update_without_CI_Status, name="update_ticket_without_CI")
...
def document_success_status_with_CI(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    playbook_local__CSAA_Closure_Notes_to_SOC_1(container=container)
...
def send_email_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    parameters.append({
        'cc': "",
        'to': "DLITSecurityIncidentResponse@csaa.com",
        'bcc': "",
...
def filter_5(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        container=container,
        conditions=[
            ["artifact:*.cef.autoclosetime", "!=", ""],
        ],
        name="filter_5:condition_1")

    # call connected blocks if filtered artifacts or results
    if matched_artifacts_1 or matched_results_1:
        delete_autoclose_artifact(action=action, success=success, container=container, results=results, handle=handle, custom_function=custom_function, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)

    return

def delete_autoclose_artifact(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('delete_autoclose_artifact() called')
    
    filtered_artifacts_data_1 = phantom.collect2(container=container, datapath=['filtered-data:filter_5:condition_1:artifact:*.id'])
    filtered_artifacts_item_1_0 = [item[0] for item in filtered_artifacts_data_1]
    ...
    delete_artifact_url = '{0}/artifact/{1}'.format(base_url, artifact_id)
    
    response = phantom.requests.delete(delete_artifact_url, verify=False)
...
def playbook_local__CSAA_Closure_Notes_to_SOC_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug('playbook_local__CSAA_Closure_Notes_to_SOC_1() called')
    
    # call playbook "local/[CSAA][Closure Notes to SOC]", returns the playbook_run_id
    playbook_run_id = phantom.playbook(playbook="local/[CSAA][Closure Notes to SOC]", container=container)
